...
var _0n5, _1n5, hasHexBuiltin2, hexes3, asciis2, isPosBig2, bitMask2, u8n, u8fr, validatorFns;
var init_utils2 = __esm({
  "node_modules/viem/node_modules/@noble/curves/esm/abstract/utils.js"() {
    ...
    isPosBig2 = (n) => typeof n === "bigint" && _0n5 <= n;
    bitMask2 = (n) => (_1n5 << BigInt(n)) - _1n5;
...
function Field2(ORDER, bitLen4, isLE2 = false, redef = {}) {
  if (ORDER <= _0n6)
  ...
  const f = Object.freeze({
    ...
    isValid: (num2) => {
      ...
      return _0n6 <= num2 && num2 < ORDER;
    },
    is0: (num2) => num2 === _0n6,
    isOdd: (num2) => (num2 & _1n6) === _1n6,
...
var _0n6, _1n6, _2n4, _3n3, _4n3, _5n2, _8n2, FIELD_FIELDS2;
...
var _0n7, _1n7, pointPrecomputes2, pointWindowSizes2;
...
function weierstrassPoints(opts) {
  ...
  function isWithinCurveOrder(num2) {
    return inRange2(num2, _1n8, CURVE.n);
  }
  function normPrivateKeyToScalar(key) {
    ...
    if (wrapPrivateKey)
      num2 = mod2(num2, N);
    aInRange2("private key", num2, _1n8, N);
    return num2;
  }
...
function weierstrass2(curveDef) {
  ...
  class Signature {
    constructor(r, s, recovery) {
      ...
      aInRange2("s", s, _1n8, CURVE_ORDER);
      this.r = r;
      this.s = s;
      if (recovery != null)
  ...
  function int2octets(num2) {
    aInRange2("num < 2^" + nBitLength, num2, _0n8, ORDER_MASK);
...
function SWUFpSqrtRatio(Fp, Z) {
  const q = Fp.ORDER;
  let l = _0n8;
  for (let o = q - _1n8; o % _2n5 === _0n8; o /= _2n5)
    l += _1n8;
  const c1 = l;
  ...
  const c7 = Fp.pow(Z, (c2 + _1n8) / _2n5);
  let sqrtRatio = (u, v) => {
    let tv1 = c6;
    let tv2 = Fp.pow(v, c4);
    let tv3 = Fp.sqr(tv2);
...
function mapToCurveSimpleSWU(Fp, opts) {
  ...
  return (u) => {
    ...
    const tv4_inv = FpInvertBatch2(Fp, [tv4], true)[0];
    x = Fp.mul(x, tv4_inv);
    return { x, y };
  };
}
var DERErr2, DER2, _0n8, _1n8, _2n5, _3n4, _4n4;
...
function createCurve2(curveDef, defHash) {
  const create2 = (hash3) => weierstrass2({ ...curveDef, ...getHash(hash3) });
...
function schnorrVerify(signature, message, publicKey) {
  ...
  const m = ensureBytes2("message", message);
  const pub2 = ensureBytes2("publicKey", publicKey, 32);
  try {
...
var secp256k1P, secp256k1N, _0n9, _1n9, _2n6, divNearest2, Fpk12, secp256k12, TAGGED_HASH_PREFIXES, pointToBytes, numTo32b, modP, modN, Point, GmulAdd, num, schnorr, isoMap, mapSWU, secp256k1_hasher, hashToCurve, encodeToCurve;
var init_secp256k1 = __esm({
  "node_modules/viem/node_modules/@noble/curves/esm/secp256k1.js"() {
    ...
    _1n9 = BigInt(1);
    _2n6 = BigInt(2);
    divNearest2 = (a, b) => (a + b / _2n6) / b;
    Fpk12 = Field2(secp256k1P, void 0, void 0, { sqrt: sqrtMod2 });
    ...
    modP = (x) => mod2(x, secp256k1P);
    modN = (x) => mod2(x, secp256k1N);
    Point = /* @__PURE__ */ (() => secp256k12.ProjectivePoint)();
    ...
    isoMap = /* @__PURE__ */ (() => isogenyMap(Fpk12, [
      // xNum
      [
    ...
    mapSWU = /* @__PURE__ */ (() => mapToCurveSimpleSWU(Fpk12, {
      A: BigInt("0x3f8731abdd661adca08a5558f0f5d272e953d363cb6f0e5d405447c01a444533"),
      B: BigInt("1771"),
      Z: Fpk12.create(BigInt("-11"))
    }))();
    secp256k1_hasher = /* @__PURE__ */ (() => createHasher2(secp256k12.ProjectivePoint, (scalars) => {
...
var _0n10, _1n10, _2n7, _7n2, _256n, _0x71n, SHA3_PI, SHA3_ROTL, _SHA3_IOTA, IOTAS, SHA3_IOTA_H, SHA3_IOTA_L, rotlH, rotlL, Keccak, gen, keccak_256;
var init_sha3 = __esm({
  "node_modules/@noble/hashes/esm/sha3.js"() {
    init_u64();
    init_utils();
...
var init_transaction = __esm({
  "node_modules/viem/_esm/errors/transaction.js"() {
    ...
    init_formatGwei();
    init_base();
    FeePayerNonceMismatchError = class extends BaseError {
    ...
    TransactionExecutionError = class extends BaseError {
      constructor(cause, { account: account2, docsPath: docsPath8, chain, data, gas, gasPrice, maxFeePerGas, maxPriorityFeePerGas, nonce: nonce2, to, value }) {
...
function decodeBytes(cursor, param, { staticPosition }) {
  ...
  const value = bytesToHex2(cursor.readBytes(Number.parseInt(size5, 10), 32));
  return [value, 32];
}
...
var init_contract = __esm({
  "node_modules/viem/_esm/errors/contract.js"() {
    ...
    CallExecutionError = class extends BaseError {
      constructor(cause, { account: account_, docsPath: docsPath8, chain, data, gas, gasPrice, maxFeePerGas, maxPriorityFeePerGas, nonce: nonce2, to, value, stateOverride }) {
...
var init_request = __esm({
  "node_modules/viem/_esm/errors/request.js"() {
    ...
    ResponseBodyTooLargeError = class extends BaseError {
...
function getNodeError(err2, args) {
  ...
  const executionRevertedError = err2 instanceof BaseError ? err2.walk((e) => e?.code === ExecutionRevertedError.code) : err2;
...
function bytesToNumberBE3(bytes) {
  return hexToNumber4(bytesToHex4(bytes));
}
function bytesToNumberLE3(bytes) {
  abytes3(bytes);
  return hexToNumber4(bytesToHex4(Uint8Array.from(bytes).reverse()));
}
...
function aInRange3(title, n, min, max) {
...
var _0n11, _1n11, hasHexBuiltin3, hexes4, asciis3, isPosBig3, bitMask3, u8n2, u8fr2, validatorFns2;
var init_utils5 = __esm({
  "node_modules/ox/node_modules/@noble/curves/esm/abstract/utils.js"() {
    ...
    typeof Uint8Array.from([]).toHex === "function" && typeof Uint8Array.fromHex === "function";
    hexes4 = /* @__PURE__ */ Array.from({ length: 256 }, (_, i) => i.toString(16).padStart(2, "0"));
    asciis3 = { _0: 48, _9: 57, A: 65, F: 70, a: 97, f: 102 };
    isPosBig3 = (n) => typeof n === "bigint" && _0n11 <= n;
    bitMask3 = (n) => (_1n11 << BigInt(n)) - _1n11;
...
var encoder4, hexes5, IntegerOutOfRangeError2, InvalidHexTypeError, InvalidHexValueError, SizeOverflowError3, SliceOffsetOutOfBoundsError3, SizeExceedsPaddingSizeError3;
var init_Hex = __esm({
  "node_modules/ox/_esm/core/Hex.js"() {
    init_Errors();
    init_hex();
...
async function call2(client, args) {
  const { account: account_ = client.account, authorizationList, batch = Boolean(client.batch?.multicall), blockHash, blockNumber, blockTag = client.experimental_blockTag ?? "latest", requireCanonical, accessList, blobs, blockOverrides, code, data: data_, factory, factoryData, gas, gasPrice, maxFeePerBlobGas, maxFeePerGas, maxPriorityFeePerGas, nonce: nonce2, requestOptions, to, value, stateOverride, ...rest } = args;
  const account2 = account_ ? parseAccount(account_) : void 0;
...
function createCurve(curveDef, defHash) {
  const create2 = (hash3) => weierstrass({ ...curveDef, hash: hash3 });
  return { ...create2(defHash), create: create2 };
}
...
function hashAuthorization(parameters) {
  const { chainId, nonce: nonce2, to } = parameters;
...
async function signAuthorization(parameters) {
  const { chainId, nonce: nonce2, privateKey, to = "object" } = parameters;
  const address = parameters.contractAddress ?? parameters.address;
...
function assertTransactionEIP4844(transaction) {
  ...
  if (blobVersionedHashes) {
    ...
    for (const hash3 of blobVersionedHashes) {
      ...
      const version4 = hexToNumber2(slice(hash3, 0, 1));
      if (size_ !== 32)
...
// src/identity.ts
var DIR = process.env.PAP_HOME ?? join(homedir(), ".pap");
var FILE = join(DIR, "agent.json");
var DEFAULT_RELAY = process.env.PAP_RELAY_URL ?? "https://pap.devcristobalvc.com";
...
function canonical(kind, payload) {
...
async function sign2(id, kind, payload) {
  return account(id).signMessage({ message: canonical(kind, payload) });
}
async function call(id, path, init) {
...
async function waitFor(id, path, maxMs, onTick) {
  const start = Date.now();
  let last;
  while (Date.now() - start < maxMs) {
    last = await call(id, path).catch(() => last);
    if (last && last.status !== "pending") return last;
    onTick?.(last, Date.now() - start);
...
function getContractError(err2, { abi: abi2, address, args, docsPath: docsPath8, functionName, sender }) {
  const error = err2 instanceof RawContractError ? err2 : err2 instanceof BaseError ? err2.walk((err3) => "data" in err3) || err2.walk() : {};
  const { code, data, details, message, shortMessage } = error;
  const cause = (() => {
    if (err2 instanceof AbiDecodingZeroDataError)
      return new ContractFunctionZeroDataError({ functionName, cause: err2 });
...
async function fillTransaction(client, parameters) {
  ...
  try {
    ...
    if (hasFeePayerSignature && typeof nonce2 !== "undefined" && transaction.nonce !== nonce2)
      throw new FeePayerNonceMismatchError({
        filledNonce: transaction.nonce,
        requestedNonce: nonce2
      });
...
async function prepareTransactionRequest(client, args) {
  ...
  if (prepareTransactionRequest2?.fn && prepareTransactionRequest2.runAt?.includes("beforeFillTransaction")) {
    ...
    account2 = sender ? parseAccount(sender) : void 0;
  }
  if (parameters.includes("nonce") && typeof nonce2 === "undefined" && account2 && nonceManager) {
    const chainId2 = await getChainId2();
    nonce2 = await nonceManager.consume({
      ...
      try {
        ...
        switch (err2.code) {
          ...
          case WalletConnectSessionSettlementError.code:
            throw new WalletConnectSessionSettlementError(err2);
          default:
  ...
  return new Promise((resolve, reject) => {
    ...
    (async () => {
      ...
      try {
        ...
        if (controller?.signal.aborted && isAbortError(err2)) {
          reject(errorInstance);
          return;
        }
        reject(err2);
    ...
    async request(params) {
      ...
      try {
        ...
        if (err2 instanceof HttpRequestError)
          throw err2;
        if (err2 instanceof ResponseBodyTooLargeError)
          throw err2;
...
function sqrt3mod43(Fp, n) {
  const p1div4 = (Fp.ORDER + _1n12) / _4n5;
  const root = Fp.pow(n, p1div4);
  if (!Fp.eql(Fp.sqr(root), n))
    throw new Error("Cannot find square root");
  return root;
}
function sqrt5mod83(Fp, n) {
  const p5div8 = (Fp.ORDER - _5n3) / _8n3;
  const n2 = Fp.mul(n, _2n8);
  const v = Fp.pow(n2, p5div8);
  const nv = Fp.mul(n, v);
  const i = Fp.mul(Fp.mul(nv, _2n8), v);
  const root = Fp.mul(nv, Fp.sub(i, Fp.ONE));
  if (!Fp.eql(Fp.sqr(root), n))
    throw new Error("Cannot find square root");
  return root;
...
function tonelliShanks3(P) {
  ...
  return function tonelliSlow(Fp, n) {
    ...
    while (!Fp.eql(t, Fp.ONE)) {
      ...
      const exponent = _1n12 << BigInt(M - i - 1);
      const b = Fp.pow(c, exponent);
      M = i;
      c = Fp.sqr(b);
      t = Fp.mul(t, c);
...
function FpLegendre3(Fp, n) {
  const p1mod2 = (Fp.ORDER - _1n12) / _2n8;
  const powered = Fp.pow(n, p1mod2);
  const yes = Fp.eql(powered, Fp.ONE);
  const zero = Fp.eql(powered, Fp.ZERO);
  const no = Fp.eql(powered, Fp.neg(Fp.ONE));
...
function Field3(ORDER, bitLen4, isLE2 = false, redef = {}) {
  if (ORDER <= _0n12)
    throw new Error("invalid field: expected ORDER > 0, got " + ORDER);
  ...
  const f = Object.freeze({
    ...
    isValid: (num2) => {
      if (typeof num2 !== "bigint")
        throw new Error("invalid field element: expected bigint, got " + typeof num2);
      return _0n12 <= num2 && num2 < ORDER;
    },
    is0: (num2) => num2 === _0n12,
    isOdd: (num2) => (num2 & _1n12) === _1n12,
    ...
    pow: (num2, power) => FpPow3(f, num2, power),
    ...
    toBytes: (num2) => isLE2 ? numberToBytesLE3(num2, BYTES) : numberToBytesBE3(num2, BYTES),
    fromBytes: (bytes) => {
      if (bytes.length !== BYTES)
        throw new Error("Field.fromBytes: expected " + BYTES + " bytes, got " + bytes.length);
      return isLE2 ? bytesToNumberLE3(bytes) : bytesToNumberBE3(bytes);
    },
    // TODO: we don't need it here, move out to separate fn
...
function mapHashToField3(key, fieldOrder, isLE2 = false) {
  ...
  if (len < 16 || len < minLen || len > 1024)
    throw new Error("expected " + minLen + "-1024 bytes of input, got " + len);
  const num2 = isLE2 ? bytesToNumberLE3(key) : bytesToNumberBE3(key);
  const reduced = mod3(num2, fieldOrder - _1n12) + _1n12;
  return isLE2 ? numberToBytesLE3(reduced, fieldLen) : numberToBytesBE3(reduced, fieldLen);
}
...
function getW3(P) {
  return pointWindowSizes3.get(P) || 1;
}
...
function numToSizedHex2(num2, size5) {
  return bytesToHex4(numberToBytesBE3(num2, size5));
}
var _0n14 = BigInt(0);
var _1n14 = BigInt(1);
var _2n9 = BigInt(2);
...
function weierstrassPoints2(opts) {
  ...
  if (Fp.is0(Fp.add(_4a3, _27b2)))
    throw new Error("bad curve params: a or b");
  function isWithinCurveOrder(num2) {
    return inRange3(num2, _1n14, CURVE.n);
  }
  function normPrivateKeyToScalar(key) {
    const { allowedPrivateKeyLengths: lengths, nByteLength, wrapPrivateKey, n: N } = CURVE;
    if (lengths && typeof key !== "bigint") {
    ...
    let num2;
    try {
      num2 = typeof key === "bigint" ? key : bytesToNumberBE3(ensureBytes3("private key", key, nByteLength));
    } catch (error) {
      throw new Error("invalid private key, expected hex or " + nByteLength + " bytes, got " + typeof key);
    }
    if (wrapPrivateKey)
      num2 = mod3(num2, N);
    aInRange3("private key", num2, _1n14, N);
    return num2;
  }
  function aprjpoint(other) {
    if (!(other instanceof Point2))
  ...
  class Point2 {
     ...
     */
    static normalizeZ(points) {
      const toInv = FpInvertBatch3(Fp, points.map((p) => p.pz));
      return points.map((p, i) => p.toAffine(toInv[i])).map(Point2.fromAffine);
    }
    /**
     * Converts hash string or Uint8Array to Point.
     ...
     */
    static fromHex(hex) {
      const P = Point2.fromAffine(fromBytes4(ensureBytes3("pointHex", hex)));
      P.assertValidity();
      return P;
    }
    // Multiplies generator point by privateKey.
    ...
    multiplyUnsafe(sc) {
      const { endo: endo2, n: N } = CURVE;
      aInRange3("scalar", sc, _0n14, N);
      const I = Point2.ZERO;
      if (sc === _0n14)
        return I;
      if (this.is0() || sc === _1n14)
        return this;
      if (!endo2 || wnaf.hasPrecomputes(this))
        return wnaf.wNAFCachedUnsafe(this, sc, Point2.normalizeZ);
      let { k1neg, k1, k2neg, k2 } = endo2.splitScalar(sc);
    ...
    multiply(scalar) {
      const { endo: endo2, n: N } = CURVE;
      aInRange3("scalar", scalar, _1n14, N);
      let point, fake;
      if (endo2) {
        const { k1neg, k1, k2neg, k2 } = endo2.splitScalar(scalar);
        let { p: k1p, f: f1p } = this.wNAF(k1);
  ...
  Point2.ZERO = new Point2(Fp.ZERO, Fp.ONE, Fp.ZERO);
  const { endo, nBitLength } = CURVE;
  const wnaf = wNAF3(Point2, endo ? Math.ceil(nBitLength / 2) : nBitLength);
  return {
    CURVE,
    ProjectivePoint: Point2,
    normPrivateKeyToScalar,
...
function weierstrass3(curveDef) {
  ...
  class Signature {
    constructor(r, s, recovery) {
      ...
      aInRange3("s", s, _1n14, CURVE_ORDER);
      this.r = r;
      this.s = s;
      if (recovery != null)
        this.recovery = recovery;
  ...
  const ORDER_MASK = bitMask3(nBitLength);
  function int2octets(num2) {
    aInRange3("num < 2^" + nBitLength, num2, _0n14, ORDER_MASK);
    return numberToBytesBE3(num2, nByteLength);
  }
  function prepSig(msgHash, privateKey, opts = defaultSigOpts) {
    if (["recovered", "canonical"].some((k) => k in opts))
      throw new Error("sign() legacy options not supported");
...
function createCurve3(curveDef, defHash) {
  const create2 = (hash3) => weierstrass3({ ...curveDef, ...getHash2(hash3) });
  return { ...create2(defHash), create: create2 };
}
...
var _1n15 = BigInt(1);
var _2n10 = BigInt(2);
var divNearest3 = (a, b) => (a + b / _2n10) / b;
function sqrtMod3(y) {
  const P = secp256k1P2;
  const _3n7 = BigInt(3), _6n = BigInt(6), _11n = BigInt(11), _22n = BigInt(22);
  const _23n = BigInt(23), _44n = BigInt(44), _88n = BigInt(88);
  ...
  const b11 = pow23(b9, _2n10, P) * b2 % P;
  ...
  const root = pow23(t2, _2n10, P);
  if (!Fpk13.eql(Fpk13.sqr(root), y))
    throw new Error("Cannot find square root");
  return root;
}
var Fpk13 = Field3(secp256k1P2, void 0, void 0, { sqrt: sqrtMod3 });
...
init_transaction();
init_toHex();
async function getTransaction(client, { blockHash, blockNumber, blockTag: blockTag_, hash: hash3, index: index2, sender, nonce: nonce2 }) {
...
async function simulateCalls(client, parameters) {
  ...
  const assetAddresses = discovery ? [
    .../* @__PURE__ */ new Set([
      ...tokensFromLogs(discovery[0].calls.flatMap((call3) => call3.logs ?? []), account2.address),
      ...
      ...parameters.calls.map((call3) => call3.to?.toLowerCase())
    ])
  ...
  const decimals = (block_decimals?.calls ?? []).map((call3) => decodeAssetResult(call3, decimalsFunction));
  const symbols = (block_symbols?.calls ?? []).map((call3) => decodeAssetResult(call3, symbolFunction));
  const tokenURI = (block_tokenURI?.calls ?? []).map((call3) => decodeAssetResult(call3, tokenUriFunction));
  const changes = [];
...
function tokensFromLogs(logs, account2) {
  const account_ = pad(account2.toLowerCase(), { size: 32 });
...
async function readBalance(client, parameters) {
  const { account: account2, address, blockNumber, blockTag, data, staticCallAddress, stateOverride } = parameters;
  try {
    const result = await call2({ ...client, ccipRead: false }, {
      account: address ? zeroAddress : account2,
...
function getStaticCallAddress(addresses2) {
  const occupied = new Set(addresses2.map((address) => address.toLowerCase()));
...
async function verifyErc6492(client, parameters) {
  ...
  const { data } = await getAction(client, call2, "call")(args).catch((error) => {
...
async function getAllowance(client, parameters) {
  const { account: account2, decimals, spender, token, ...rest } = parameters;
  const [amount, { decimals: resolved }] = await Promise.all([
    readContract(client, {
      ...rest,
      ...getAllowance.call(client, { account: account2, spender, token })
    }),
...
async function getBalance2(client, parameters) {
  ...
  const account2 = parseAccount(account_).address;
  const [amount, { decimals: resolved }] = await Promise.all([
    readContract(client, {
      ...rest,
      ...getBalance2.call(client, { account: account2, token })
    }),
    resolveTokenWithDecimals(client, {
      decimals,
      token
...
var pub = createPublicClient({ chain: hskTestnet, transport: http() });
var cached;
async function addresses(id) {
  if (cached) return cached;
  const h = await call(id, "/api/health");
  cached = h.addresses;
  return cached;
}
...
var buf = (b) => b;
async function aesKey(shared, epk) {
...
async function eciesEncrypt(recipientPub, plaintext, aad2) {
  const eph = secp256k1.utils.randomPrivateKey();
  const epk = secp256k1.getPublicKey(eph, true);
  const key = await aesKey(secp256k1.getSharedSecret(eph, hexToBytes2(recipientPub), true), epk);
  const iv = globalThis.crypto.getRandomValues(new Uint8Array(12));
  const ct = new Uint8Array(
    await subtle().encrypt({ name: "AES-GCM", iv, additionalData: utf8.encode(aad2) }, key, buf(plaintext))
  );
  return { v: 1, alg: "secp256k1-hkdf-sha256-aes256gcm", epk: bytesToHex2(epk), iv: bytesToHex2(iv), ct: bytesToHex2(ct) };
}
async function eciesDecrypt(privateKey, env, aad2) {
  if (env?.v !== 1 || env.alg !== "secp256k1-hkdf-sha256-aes256gcm") throw new Error("unsupported envelope");
  const epk = hexToBytes2(env.epk);
  const key = await aesKey(secp256k1.getSharedSecret(hexToBytes2(privateKey), epk, true), epk);
  try {
    return new Uint8Array(
      await subtle().decrypt(
        { name: "AES-GCM", iv: buf(hexToBytes2(env.iv)), additionalData: utf8.encode(aad2) },
        key,
        buf(hexToBytes2(env.ct))
      )
    );
  } catch {
...
var SECRET_NAME = /^[a-z0-9][a-z0-9_-]{0,63}$/;
...
var aad = (layer, agent, name) => `pap:${layer}:${agent.toLowerCase()}:${name}`;
var encodeEnv = (e) => JSON.stringify(e);
var decodeEnv = (s) => JSON.parse(s);
async function sealSecret(secret, t) {
...
async function openAgentLayer(inner, agentPk, expect) {
...
function typedData(verifyingContract, primaryType, message) {
  return { domain: papDomain(verifyingContract), types: papTypes, primaryType, message };
}
...
var ExpiredError = class extends Error {
  code = 4900;
};
...
async function seal(id, name, value, opts) {
  requirePaired(id);
...
async function requestReveal(id, name, reason) {
  ...
  return call(id, "/api/requests", {
    method: "POST",
    body: JSON.stringify({ agentAddress: id.address, action: { type: "reveal", ...wire(msg) }, sig })
  });
}
async function awaitReveal(id, requestId, name, maxMs) {
  const st = await waitFor(id, `/api/requests/${requestId}`, maxMs);
...
function writeSecretFile(name, value) {
  const dir = join2(identityDir(), "secrets");
  mkdirSync2(dir, { recursive: true, mode: 448 });
  const file = join2(dir, name);
  writeFileSync2(file, value, { mode: 384 });
  chmodSync(file, 384);
  return file;
}
  ...
  return new Promise((resolve) => {
    ...
    process.stdin.on("data", (ch) => {
      for (const c of ch) {
        ...
        if (c === "") err("cancelled");
        if (c === "\x7F") v = v.slice(0, -1);
        else v += c;
      }
    });
  });
}
async function reveal(id, name, reason) {
  ...
  process.stderr.write(`Waiting for approval on your phone\u2026 (QR: ${showUrl} \xB7 phone: ${url})
`);
  openBrowser(showUrl);
  try {
...
owner  ${id.ownerAddress ?? "not paired"}${id.agentId ? ` \xB7 agentId #${id.agentId}` : ""}
relay  ${id.relay}`);
    return;
  }
  if (cmd === "seal") {
  ...
  if (cmd === "secret") {
    ...
    if (sub === "list") {
      ...
      for (const s of list)
        console.log(`${s.name.padEnd(20)} ${s.status.padEnd(8)} ${s.reads}/${s.maxReads} reads  expires ${new Date(Number(s.expiry) * 1e3).toISOString().slice(0, 10)}`);
      return;
    }
    if (sub === "get") {
